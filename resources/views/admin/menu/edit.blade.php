{{-- filepath: /home/acra/bliss/resources/views/admin/menu/edit.blade.php --}}
@extends('layouts.app')

@section('content')
<div class="p-6 bg-gray-100 min-h-screen">
    <h1 class="text-2xl font-semibold mb-8 ml-12">Edit Menu</h1>

    <form action="{{ route('penjual.menu.update', $menu->id) }}" method="POST">
        @csrf
        @method('PUT')
